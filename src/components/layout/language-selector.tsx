...
function localizedDestination(pathname: string, locale: CompoundLocale) {
  ...
  const employmentCalculator = pathname.match(
    /^\/(?:ko|en)\/employment\/(severance-pay|net-salary|unemployment-benefits|weekly-holiday-pay|hourly-wage|social-insurance|average-wage|salary-raise|overtime-pay)$/,
  );
